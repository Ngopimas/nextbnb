...
User.init(
  ...
  },
  {
    sequelize,
    modelName: "user",
    timestamps: false, // no createdAt and updatedAt fields in the table
    hooks: {
...
// If a model is modified, call this sync() model method again to keep the table in sync with the model
